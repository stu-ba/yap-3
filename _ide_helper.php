...
namespace Illuminate\Support\Facades {
    ...
    class Artisan {
        ...
        public static function handle($input, $output = null)
        {
            ...
            return \Yap\Console\Kernel::handle($input, $output);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \Yap\Console\Kernel::terminate($input, $status);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Yap\Console\Kernel::command($signature, $callback);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \Yap\Console\Kernel::registerCommand($command);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Yap\Console\Kernel::call($command, $parameters, $outputBuffer);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \Yap\Console\Kernel::queue($command, $parameters);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Yap\Console\Kernel::output();
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \Yap\Console\Kernel::setArtisan($artisan);
        }
    ...
    class Hash {
        ...
        {
            return \Kyslik\Django\Hashing\BcryptHasher::make($value, $options);
        }
        ...
        {
            return \Kyslik\Django\Hashing\BcryptHasher::check($value, $hashedValue, $options);
        }
        ...
        {
            return \Kyslik\Django\Hashing\BcryptHasher::needsRehash($hashedValue, $options);
        }
        ...
        public static function setRounds($rounds)
        {
            ...
            return \Kyslik\Django\Hashing\BcryptHasher::setRounds($rounds);
        }
