                                ...
                                @foreach ($projects as $project)
                                    <tr class="{{ (!is_null($project->archive_at) && $project->archive_at->isToday()) ? 'info': '' }}">
                                        ...
                                        <td>
                                            ...
                                            @includeWhen($current->can('edit', $project), 'components.html.fa-button', ['href' => route('projects.edit', ['project' => $project]), 'tooltip' => 'Edit project', 'class' => 'btn btn-xs btn-primary'.disabledIf(!$project->is_archived), 'icon' => fa('edit')])
