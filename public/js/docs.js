...
/* WEBPACK VAR INJECTION */(function(global) {/* http://prismjs.com/download.html?themes=prism&languages=markup+css+clike+javascript+apacheconf+batch+c+bison+cpp+git+go+haskell+http+latex+markdown+matlab+nginx+php+php-extras+python+sql+vim+yaml */
